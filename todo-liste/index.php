    ...
    echo $_POST['pseudo'];
      ...
      while($email_verification = $req->fetch()){
       ...
       $secret = sha1($secret).time().time();
        ...
        // ENVOI DE LA REQUETE = crér utilisateur
...
<html>
    ...
    <body>
        ...
        <div class="container">
             ...
             <?php 
              if(!isset($_SESSION['connect'])){ ?>  
                    ...
                    <p id="info">Bievenue sur mon site, pour en avoir plus, inscrivez-vous.
                        Sinon, <a href="connection.php">Connectez-vous</a>
                    </p>

                    <?php

            // pour afficher ce <p> au tabeleau si mot depasse n'ést egale = PASSWORD CONFIRM
                    if(isset($_GET['error'])){
                        ...
                        if(isset($_GET['pass'])){
                            ...
                            // TEST SI EMAIL UTILISE est déja utiliser message d'error
                        //    ------------------------------------
                        } elseif(isset($_GET['email'])){
                        echo '<p id="error"> Cette adresse email est déja prise</p>';
                        }
                        //    ------------------------------------
                    }
        ...
        <a href="disconnection.php">Dècoonexion</a>
            </p>
